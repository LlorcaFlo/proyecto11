<?php
//Función con las expresiones regulares para la validación del email!!!
//Recibe el email y lo valida... 
...
//Si existe la variable dentro de email pasar por la funcion para arreglar espacios...
	if(isset($_POST[$campo])){
		$_POST[$campo] = format_entra($campo);
...
//Recibe el email y quita los espacios en blanco
